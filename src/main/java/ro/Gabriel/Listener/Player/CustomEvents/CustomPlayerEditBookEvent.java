...
public class CustomPlayerEditBookEvent<PlayerType extends SpigotUser> extends CustomPlayerEvent<PlayerType> implements Cancellable {
    ...
    public CustomPlayerEditBookEvent(Player player, PlayerType spigotUser, BookMeta previousBookMeta, BookMeta newBookMeta, int slot, boolean isSigning) {
